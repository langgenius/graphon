...
def test_invalid_references():
    ...
    cases = [
        TestCase(name="lack of closing brace", template="Hello, {{#sys.user_id#"),
        TestCase(name="lack of opening brace", template="Hello, #sys.user_id#}}"),
        TestCase(name="lack selector name", template="Hello, {{#sys#}}"),
        TestCase(name="empty node name part", template="Hello, {{#.user_id#}}"),
    ]
