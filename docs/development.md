...
| Change event delivery or ordering | [event stream](../src/graphon/engine/event/stream.py), [filter chain](../src/graphon/engine/filter/chain.py) | [event stream tests](../tests/engine/test_event_stream.py), [filter chain tests](../tests/engine/test_event_filters.py) |
...
| Change persistence or resume | [runtime state](../src/graphon/runtime/runtime_state/), [container state](../src/graphon/runtime/container_state.py), [response filter and snapshots](../src/graphon/engine/filter/builtin/response_stream/) | [runtime tests](../tests/runtime/), [engine serialization](../tests/engine/test_runtime_state_serialization.py), [response snapshots](../tests/engine/test_response_stream_snapshot.py), [restored response chunks](../tests/engine/test_response_stream_filter.py), [version isolation](../tests/test_snapshot_version_isolation.py) |
