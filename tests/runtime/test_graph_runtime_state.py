...
class TestGraphRuntimeState:
    ...
    def test_read_only_wrapper_serializes_runtime_state(self) -> None:
        ...
        state.ready_queue.put(ReadyTask(frame_id="root", node_id="node-1"))
    ...
    def test_dumps_and_loads_roundtrip(self) -> None:
        ...
        state.ready_queue.put(ReadyTask(frame_id="root", node_id="node-A"))
        ...
        assert restored.ready_queue.get(timeout=0.01) == ReadyTask(
            frame_id="root",
            node_id="node-A",
        )
